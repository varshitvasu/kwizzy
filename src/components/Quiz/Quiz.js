    ...
    return (
        <React.Fragment>
            ...
            <div className="topbar d-flex align-items-center flex-row-reverse">
                <h2><Timer finish={handleQuit} time={300} /></h2>
            </div>
            ...
            <div className="quiz d-flex align-items-center justify-content-center flex-column">
                            ...
                            <div class="card border-secondary transparent mt-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div className="mr-auto">
                                        ...
                                        </button> : <button className="btn btn-outline-success me-2" id="finish" value="Finish" onClick={handleFinish}>Finish Attempt</button>}
                                    </div>
                                </div>
                ...
                }
                {
                    ...
                    <h4>Your score is {score.current}</h4>
                    </div>
                }
            </div>
